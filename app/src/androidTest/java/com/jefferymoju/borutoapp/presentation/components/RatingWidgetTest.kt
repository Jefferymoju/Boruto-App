package com.jefferymoju.borutoapp.presentation.components
...
class RatingWidgetTest {
    ...
    @Test
    fun passZeroPointFiveValue_Assert_FourEmptyStarsOneHalfFilledStar(){
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.5
    ...
    @Test
    fun passFourPointZeroValue_Assert_FourFilledStarsOneEmptyStar(){
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.0
    ...
    @Test
    fun passFourPointThreeValue_Assert_FourEmptyStarsOneHalfFilledStar(){
        composeTestRule.setContent {
            RatingWidget(
                modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.3
